#!/usr/bin/env bash
# Compile the dateutil-parse Mojo kernel into a shared library
...
mojo build --emit shared-lib -o "build/${lib}" src/dateutilmojo.mojo
echo "built kernels/dateutil-parse/build/${lib}"
