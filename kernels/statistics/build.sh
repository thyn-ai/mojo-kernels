#!/usr/bin/env bash
# Compile the statistics Mojo kernel into a shared library (macOS .dylib /
...
mojo build --emit shared-lib -o "build/${lib}" src/statsmojo.mojo
echo "built kernels/statistics/build/${lib}"
