#!/usr/bin/env bash
# Compile the MiniSearch fuzzy/BM25 Mojo kernel into a shared library
...
mojo build --emit shared-lib -o "build/${lib}" src/msmojo.mojo
echo "built kernels/minisearch_fuzzy/build/${lib}"
