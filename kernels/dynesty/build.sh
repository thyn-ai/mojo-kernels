#!/usr/bin/env bash
# Compile the dynesty-sampler Mojo kernel into a shared library
...
mojo build --emit shared-lib -o "build/${lib}" src/dynestymojo.mojo
echo "built kernels/dynesty/build/${lib}"
