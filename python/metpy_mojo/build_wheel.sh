#!/usr/bin/env bash
# Build the metpy-mojo platform wheel (wheel-only; no sdist), then repair it:
...
# Without this step the wheel's libmetpycapemojo resolves its runtime
...
#
# Run directly: bash python/metpy_mojo/build_wheel.sh
#
