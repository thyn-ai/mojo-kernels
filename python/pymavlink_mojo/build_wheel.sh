#!/usr/bin/env bash
# Build the pymavlink-mojo platform wheel (wheel-only; no sdist), then repair
...
# Without this step the wheel's libpymavmojo resolves its runtime dependencies
...
#   pixi run bash python/pymavlink_mojo/build_wheel.sh
#
