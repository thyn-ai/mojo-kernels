#!/usr/bin/env bash
# Build the croniter-mojo platform wheel (wheel-only; no sdist), then repair it:
...
# Without this step the wheel's libcronitermojo resolves its runtime dependencies
