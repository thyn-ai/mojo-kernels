#!/usr/bin/env bash
# Build the msgpack-mojo platform wheel (wheel-only; no sdist), then repair it:
...
# Without this step the wheel's libmsgpackmojo resolves its runtime dependencies
