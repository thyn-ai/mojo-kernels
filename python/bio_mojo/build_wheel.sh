#!/usr/bin/env bash
# Build the bio-mojo platform wheel (wheel-only; no sdist), then repair it:
...
# Without this step the wheel's libbioparse resolves its runtime dependencies
...
#   pixi run bash python/bio_mojo/build_wheel.sh
#
