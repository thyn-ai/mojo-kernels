...
cp "$dist/minisearch-mojo-core-0.1.0.tgz" "$dist/$platform_pkg" /tmp/ms-mojo-smoke-native/vendor/
...
cp "$dist/minisearch-mojo-core-0.1.0.tgz" /tmp/ms-mojo-smoke-win/vendor/
