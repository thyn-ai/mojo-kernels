...
cp "$dist/ckmeans-mojo-core-0.1.0.tgz" "$dist/$platform_pkg" /tmp/ckmeans-mojo-smoke-native/vendor/
...
cp "$dist/ckmeans-mojo-core-0.1.0.tgz" /tmp/ckmeans-mojo-smoke-win/vendor/
