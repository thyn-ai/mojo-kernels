...
# compiled fusemojo kernel, then repair it: vendor the Mojo runtime shared
...
#
# Run inside the repo pixi environment (`pixi run pack-fuse`).
#
...
src="${FUSE_MOJO_NATIVE_SRC:-$repo_root/kernels/fuse/build/$lib}"
